define('TEMP',['template'],function(){
	...
	H.main='<div class="main">'
			  ...
			  +'	</div>'
			  +'	<div class="m-tablist-wrapper clearfix"><ul class="m-tablist">'
			  ...
			  +'	</ul><a class="m-pinglun" href="javascript:void(0)"><span class="iconfont">&#xe601;</span>评论</a><div class="clear"></div></div>'
